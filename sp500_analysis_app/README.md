...
The last ranked results are saved to the browser's local storage. On page load, the dashboard shows the saved results immediately instead of rescanning the market; use the refresh button to run a new scan on request.
