...
const appViews = {
  ...
  wallet: `<div class="app-header"><h2>Wallet</h2><button class="app-back" data-close-app>Done</button></div><div class="app-body"><div class="app-hero" style="background:linear-gradient(135deg,#24252b,#5d5f67)"><p>VISA</p><h3>•••• 4820</h3><p>Kanayo A.</p></div><p style="font-size:11px;color:#777">Double-click the side button to pay.</p></div>`,
