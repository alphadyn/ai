...
const appViews = {
  messages: `<div class="app-header"><h2>Messages</h2><button class="app-back" data-close-app>Done</button></div><div class="app-body"><div class="app-hero"><h3>Good morning.</h3><p>Your conversations, right where you left them.</p></div><div class="list-item"><span class="list-dot">A</span><div><strong>Alphadyn</strong><small>Welcome to Alphadyn AI</small></div></div><div class="list-item"><span class="list-dot" style="background:#9b7dea">J</span><div><strong>Jordan Lee</strong><small>Shared a location with you</small></div></div><div class="list-item"><span class="list-dot" style="background:#f18b56">M</span><div><strong>Mom</strong><small>Photo · Yesterday</small></div></div></div>`,
