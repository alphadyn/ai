...
- [prime_counter_app](prime_counter_app/) - A browser app that counts primes up to a user-supplied number, reports computation time, and logs the last 100 results.
